...
echo Converting %~nx1
convert "%~1" -quality 95 -crop 328x218+869+467 +repage "%~dp1%folder%\Lamp - %~n1.png"
::	the MLAA images are shifted somehow, so I need a different Y offset
::convert "%~1" -quality 95 -crop 328x218+869+467 +repage "%~dp1%folder%\Lamp - %~n1.png"
convert "%~1" -quality 95 -crop 236x461+1410+189 +repage "%~dp1%folder%\Door - %~n1.png"
