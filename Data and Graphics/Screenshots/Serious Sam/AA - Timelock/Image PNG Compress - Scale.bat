...
echo Converting %~nx1
convert "%~1" -quality 95 -crop 154x390+642+390 +repage -filter point -resize 300%% "%~dp1%folder%\Time-Lock - %~n1.png"
convert "%~1" -quality 95 -crop 1048x160+94+275 +repage -filter point -resize 300%% "%~dp1%folder%\Temple - %~n1.png"
