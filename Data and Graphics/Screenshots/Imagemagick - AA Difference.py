...
for IMAG in os.listdir(droppedPath):
	if "MLAA" in IMAG:
		MLAA.append(IMAG)
	else:
		BASE.append(IMAG)

for POS in range(0, len(MLAA)):
	os.system("convert \"" + BASE[POS] + "\" \"" + MLAA[POS] + "\" -compose difference -composite \"" + droppedPath + "Difference\\MLAA Difference " + BASE[POS] + "\"")
