...
#setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Serious Statistics AA/Data/DX11 - GC/FXAA/")
results <- read_csv("04 - FXAA Medium - OCAT.csv")
...
if(TRUE) {
sink("Output - 04 - FXAA Medium - OCAT.txt", split=TRUE)
writeLines("04 - FXAA Medium - OCAT")
if (titled) {
