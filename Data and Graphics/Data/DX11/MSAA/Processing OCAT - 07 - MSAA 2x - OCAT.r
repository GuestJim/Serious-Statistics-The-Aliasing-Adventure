...
#setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Serious Statistics AA/Data/DX11 - GC/MSAA/")
results <- read_csv("07 - MSAA 2x - OCAT.csv")
...
if(TRUE) {
sink("Output - 07 - MSAA 2x - OCAT.txt", split=TRUE)
writeLines("07 - MSAA 2x - OCAT")
if (titled) {
