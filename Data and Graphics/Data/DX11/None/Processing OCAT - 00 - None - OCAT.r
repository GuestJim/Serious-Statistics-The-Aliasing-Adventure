...
#setwd("E:/Users/Jim/My Documents/OCC/@Reviews/Serious Statistics AA/Data/DX11 - GC/None/")
results <- read_csv("00 - None - OCAT.csv")
...
if(TRUE) {
sink("Output - 00 - None - OCAT.txt", split=TRUE)
writeLines("00 - None - OCAT")
if (titled) {
