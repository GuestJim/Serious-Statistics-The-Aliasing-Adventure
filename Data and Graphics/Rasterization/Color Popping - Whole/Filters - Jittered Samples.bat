...
convert -size 1024x1024 -define sample:offset=25x25 -sample 8x8 "%~1" -quality 95 %scale% %background% "%~dp1%folder%\%~n1 - A UL.png"
convert -size 1024x1024 -define sample:offset=75x25 -sample 8x8 "%~1" -quality 95 %scale% %background% "%~dp1%folder%\%~n1 - B UR.png"
convert -size 1024x1024 -define sample:offset=25x75 -sample 8x8 "%~1" -quality 95 %scale% %background% "%~dp1%folder%\%~n1 - C LL.png"
convert -size 1024x1024 -define sample:offset=75x75 -sample 8x8 "%~1" -quality 95 %scale% %background% "%~dp1%folder%\%~n1 - D LR.png"
