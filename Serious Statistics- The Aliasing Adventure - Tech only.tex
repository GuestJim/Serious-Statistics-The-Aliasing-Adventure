...
%	add a QR code to the document so a print copy has a way to an electronic copy
...
\vspace{\fill}
\begin{center}
	{\changeurlcolor{black}{\qrcode[link, height=2cm, level=Quality]{https://1drv.ms/f/s!Alx_Ljviaz9bkimuJId0rZxyqD7r}}}
